...
/**
 * The cell type within the Line {@link exp.jsapar.types2.Line} object. A cell has a name and a
 * value. The value type is generic, meaning that the value type can be any of the normal data types
 * available within java.<br>
 * <br>
 ...
 * </ul>
 * Trying to add a data type that is not supported for use within the JsaPar library results in a
 * thrown {@link IllegalArgumentException} exception.<br>
 * <br>
 * 
...
public class Cell implements Serializable, Cloneable {
    ...
    /**
     * Constructs an {@link exp.jsapar.types2.Cell} with a cell name and no cell value.
     * 
     * @param name
    ...
    /**
     * Gets the value of the cell. The type of the cell is already determined when constructed or
     * set.
     * 
     * @param <T>
    ...
    public boolean equals(Object aThat) {
        ...
        return EqualsUtil.areEqual(this.name, that.name) && EqualsUtil.areEqual(this.value, that.value);
    }
