...
/**
 * Provides simple static utility methods for discovering and processing JsaPar annotations in
 * classes and fields.
 * 
...
public class AnnotationUtil {
    ...
    /**
     * Indicates whether or not the specified class contains the @Line annotation.
     * 
     * @param clazz
     *            the class to be investigated.
     * 
     * @return {@code true} when class contains the annotation, otherwise {@code false}.
     */
    ...
    /**
     * Indicates whether or not the specified field contains the @Cell annotation.
     * 
     * @param field
     *            the field to be investigated.
     * 
     * @return {@code true} when field contains the annotation, otherwise {@code false}.
     */
    ...
    /**
     * Finds the fields of the specified class that have a @Cell annotation and returns them in a
     * list.
     * 
     * @param clazz
     ...
     * 
     * @param field
     *            the field of a class that contains the @Cell annotation.
     * 
