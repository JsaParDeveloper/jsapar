...
/**
 * An ordered collection (also known as a <i>sequence</i>) of {@code Cell}
 * elements with filtering capabilities. The user of this list has precise
 * control over where in the list each element is inserted. The user can access
 * elements by their integer index (position in the list), search for elements
 * in the list, and filter the collection according to the needs of the user.
 * <p>
 * Filtering of cells is possible by adding a {@code CellFilter} to the
 * collection and setting the filtering of cells in this collection to active by
 * invoking the {@code activateFiltering()} method.
 * 
...
public class CellList implements List<Cell>, FilterableList<Cell> {
	...
	/**
	 * The list containing the filtered cells. This is the filtered version of
	 * the allCells list.
	 */
	 ...
	 * same name is added to the collection of cell elements.
	 */
	...
	/**
	 * Adds the given cell element to the complete list. When the filtering is
	 * active, the side-effect of this operation is that the filtered list will
	 * be completely refreshed. So, when adding more than one cell element, it
	 * is wisely to deactivate the filtering of this list to increase
	 * performance.
	 * 
	 * @return {@code true} if the complete list is changed as a result of the
	 *         call.
	 * 
	...
	/**
	 * Inserts the specified cell element at the specified position in this list
	 * (optional operation). Shifts the cell element currently at that position
	 * (if any) and any subsequent cell elements to the right (adds one to their
	 * indices).
	 * 
	...
	/**
	 * Appends all of the cell elements in the specified collection to the end
	 * of this list, in the order that they are returned by the specified
	 * collection's iterator (optional operation).<br>
	 * 
	 * If filtering is active, then filtering is temporarily deactivated to
	...
	/**
	 * Inserts all of the cell elements in the specified collection into this
	 * list at the specified position (optional operation). Shifts the cell
	 * element currently at that position (if any) and any subsequent cell
	 * elements to the right (increases their indices). The new cell elements
	 ...
	 * Filtering will be deactivated and the list will be empty after this call
	 * returns.
	 * 
	...
	public boolean contains(Object o) {
		...
		if (!(o instanceof Cell)) {
			throw new IllegalArgumentException(
					"The specified object is not a Cell object.");
		}
		// safe to cast
		co = (Cell) o;
	...
	public boolean containsAll(Collection<?> c) {
		...
		try {
			...
			throw new IllegalArgumentException(
					"One or more objects in the specified collection is not a Cell object.");
		}
		return true;
	}
	 ...
	 * complete collection, or -1 if the complete collection does not contain
	 * the element.
	 * 
	...
	/**
	 * Returns the index of the last occurrence of the specified cell element in
	 * this list, or -1 if this list does not contain the cell element.
	 * 
	 * @return TODO
	 * 
	...
	/**
	 * Clears the filtered collection AND deactivates the filtering. If the
	...
	/**
	 * Returns the size of the <b>filtered</b> collection. The size can be the
	 * same size or less than the total size of the collection depending on the
	 * filtering results.
	 * 
	...
	/**
	 * Returns {@code true} if the <b>filtered</b> collection contains no
	 * elements.
	 * 
	 * @return {@code true} if the <b>filtered</b> collection contains no
	 *         elements.
	 */
	@Override
	...
	/**
	 * TODO <br>
	 * Needed to insure that when iterating over the allCells list, the allCells
	 * list AND filteredCells list stay synchronized when removing cell
	 * elements.
	 * 
	 * @author JsaPar Developer
	 */
