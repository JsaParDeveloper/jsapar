...
/**
 * A collection of predefined Document objects. These Documents are used for the Document unit
 * tests. Because of the tremendous amount of code, these Documents are defined here and not in the
 * unit tests itself to prevent unreadable unit tests.<br>
 * <br>
