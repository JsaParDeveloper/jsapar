...
/**
 * Unit tests for testing the instantiation of Cell objects with divergent primitive data types.
 * 
...
public class CellTestOnAutoboxingInstantiations {
    ...
    /**
     * Tests the instantiation of a cell with a primitive byte cell value and cell name.
     */
    @Test
    ...
    /**
     * Tests the instantiation of a cell with a primitive byte cell value and cell name that is
     * empty.
     */
