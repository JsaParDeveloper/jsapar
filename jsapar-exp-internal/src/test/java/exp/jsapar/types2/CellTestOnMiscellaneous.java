...
/**
 * Miscellaneous unit tests for testing Cell objects. A mixture of unit tests that have no
 * particular classification and which can not be accommodated in other cell testing classes.
 * 
